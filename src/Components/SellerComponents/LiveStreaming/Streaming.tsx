           ...
           :null} 
            {auction.length > 0 ? (
              ...
              <View style={styles.currentBox}>
                ...
                <View style={{ alignItems:'center'}}>
                  ...
                  {bidderWon && (
                    <View
                      ...
                      <Text style={{fontSize: 14, color: 'yellow',fontWeight:'600',textTransform:'capitalize'}}>
                ...
                {!isActive  && !bidderWon && (<Text style={{color:'white',fontSize:16,textAlign:'center',
                fontWeight:'600'

                }}>Start a Auction</Text>)}
                </View>
...
const styles = StyleSheet.create({
  currentBox:{backgroundColor: '#111',
    paddingVertical:10,
