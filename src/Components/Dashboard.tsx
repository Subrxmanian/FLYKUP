  ...
  return (
    <>
      ...
      <ScrollView style={styles.container}>
        ...
        <Animatable.Text animation="zoomInUp" easing="ease-out" iterationCount={1} >
      ...
      <Animatable.View animation={'bounce'} iterationCount={10}>
        <FAB
          ...
          onPress={() => {
            ToastAndroid.show(
              'Create an Shows to start streaming.',
              ToastAndroid.SHORT,
            );
...
const styles = StyleSheet.create({
  notificationBadge: {
    position: 'absolute',
    top: -5, // Adjust as needed to position correctly
    ...
    textAlignVertical: 'center', // Center the text vertically (works on Android)
