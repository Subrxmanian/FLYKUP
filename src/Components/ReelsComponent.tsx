  ...
  const handleValidate1 = async () => {
    ...
    if (purchase.productType != 'quantity') {
      ...
      if (!selectedColor || !selectedSize) {
        ToastAndroid.show('Please choose color and size. ', ToastAndroid.SHORT);
        return
      }
    }
  ...
  function Viewing(status) {
    switch (status) {
          ...
          <View style={styles.purchaseContainer}>
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity onPress={() => setquantity(Number(qunatity) + 1)}>
      ...
      case '2':
        return (
          <View>
             <TouchableOpacity onPress={()=>{setViewPricing("1")}} style={{flexDirection:'row',marginBottom:10}}>
          ...
          <Text style={{fontSize:15}}>Back to Product selection</Text>
            ...
            <TouchableOpacity
              style={[styles.addressButton, {backgroundColor: '#372440',width:'70%',alignSelf:'center',
                paddingVertical:15}]}
              onPress={() => handleValidate1()}>
              {loading ? (
      ...
      case '3':
        return (
          <View>
       <TouchableOpacity onPress={() => { setViewPricing("2"); }} style={styles.backButton}>
      ...
      <Text style={styles.title}>Pricing Details</Text>
        ...
        <View style={styles.detailsContainer}>
          ...
          <View >
            ...
            <Text style={[styles.value, styles.address,{marginBottom:10,marginTop:10}]}>
